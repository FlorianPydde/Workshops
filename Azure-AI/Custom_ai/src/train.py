...
def train_model(model, criterion, optimizer, scheduler, num_epochs, data_dir):
    ...
    run.log('final_best_val_acc', np.float(best_acc))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--container_dir', type=str, default='./Azure-AI', help='data folder mounting point')
    parser.add_argument('--data_dir', type=str, default='/Datasets/cell_images/', help='data folder mounting point')
    ...
    parser.add_argument('--register_model', default=False, action='store_true', help='to store the model')
    args = parser.parse_args()

    data_folder = args.container_dir + args.data_dir
    print('Data folder:', data_folder)

    run = Run.get_context()
    model = fine_tune_model(args.num_epochs, data_folder, args.learning_rate, args.momentum)
